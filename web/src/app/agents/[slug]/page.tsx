...
import { toCategorySubtotals, type CategorySubtotal, type EvidenceGrade, type PublicAgencyProfile, type ArchitectureProfileResponse } from "@/lib/types"
...
export default function PublicAgencyProfilePage({
  ...
  useEffect(() => {
    ...
    publicApi
      ...
      .then((p) => {
        setProfile(p)
        return architectureApi
          .getArchitectureProfile(p.agencyId)
          .catch(() => null)
      })
      .then((arch) => setArchProfile(arch))
      .catch(() => notFound())
