  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-12">
      ...
      <Tabs defaultValue="github">
        <TabsList className="mb-6 border-2 border-[#D7D3CB] bg-[#F6F6F3]">
          <TabsTrigger value="github" className="data-[state=active]:bg-white">
        ...
        <TabsContent value="github">
          <div className="rounded-[23px] border-2 border-[#D7D3CB] bg-[#F6F6F3] p-8">
            <p className="mb-6 text-sm leading-relaxed text-[#6B6B6B]">
              ...
              <span className="font-medium text-[#279455]">GITHUB VERIFIED</span> badge.
            </p>
            <form onSubmit={githubForm.handleSubmit(onGithubSubmit)} className="space-y-4">
              <div className="space-y-1.5">
                <Label htmlFor="githubUsername">GitHub username</Label>
                <div className="flex items-center gap-2">
                  <span className="text-[#6B6B6B]">github.com/</span>
                  <Input
                    id="githubUsername"
        ...
        <TabsContent value="paste">
          <div className="rounded-[23px] border-2 border-[#D7D3CB] bg-[#F6F6F3] p-8">
            <p className="mb-6 text-sm leading-relaxed text-[#6B6B6B]">
              ...
              <span className="font-medium text-[#6B6B6B]">SELF-REPORTED</span> label — useful
            ...
            <form onSubmit={pasteForm.handleSubmit(onPasteSubmit)} className="space-y-4">
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full rounded-md border-2 border-[#D7D3CB] bg-white px-3 py-2 text-sm text-[#000000] focus:outline-none focus:ring-2 focus:ring-[#10100F]"
                >
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  className="w-full rounded-md border-2 border-[#D7D3CB] bg-white px-3 py-2 font-mono text-xs text-[#000000] focus:outline-none focus:ring-2 focus:ring-[#10100F]"
                />
